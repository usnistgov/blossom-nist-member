...
type (
	...
	AccountInterface interface {
		...
		GetAccounts(stub shim.ChaincodeStubInterface) ([]*model.AccountPublic, error)
		...
		GetAccount(stub shim.ChaincodeStubInterface, account string) (*model.Account, error)
	...
	AssetsInterface interface {
		...
		// asset.
		GetAssets(stub shim.ChaincodeStubInterface) ([]*model.AssetPublic, error)

		// GetAsset returns the info for the asset with the given asset ID.
		GetAsset(stub shim.ChaincodeStubInterface, id string) (*model.Asset, error)
		...
		GetCheckoutRequests(stub shim.ChaincodeStubInterface, account string) ([]CheckoutRequest, error)
		...
		GetLicenses(stub shim.ChaincodeStubInterface, account, assetID string) (map[string]string, error)
		...
		GetInitiatedCheckins(stub shim.ChaincodeStubInterface, account string) ([]CheckinRequest, error)
