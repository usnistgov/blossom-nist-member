...
func Super() (*ClientIdentity, error) {
	...
	return buildIdentity(str, "BlossomMSP")
}

// A1SystemOwner returns the certificate for the user a1_system_owner:Org2MSP
func A1SystemOwner() (*ClientIdentity, error) {
...
func A1AcqSpec() (*ClientIdentity, error) {
...
func A2SystemOwner() (*ClientIdentity, error) {
...
func A2AcqSpec() (*ClientIdentity, error) {
